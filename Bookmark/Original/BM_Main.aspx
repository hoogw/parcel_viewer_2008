		...
		<FORM id="BMForm" name="BMForm" runat="server">
			...
			<TABLE width="100%" cellpadding="3" cellspacing="0" border="0">
				...
				<TR>
					...
					<TD colspan="2" align="left"><FONT class="ssmsg2">To select a private bookmark stored under your name, first enter enetr your user name and then click "Look Up".  The dropdown will fill with a list of your private bookmarks. </FONT><br>
			...
			<%if ((Application("AppType") = "econdev1" and  Session("EDBMAccess")="Admin") OR Application("AppType") <> "econdev1") AND request("myapp")="" then%>
			...
			<%end if%>
			<%if (Application("AppType")<>"econdev1") then%>
			<%else%>
			<TABLE width="100%" cellpadding="3" cellspacing="0" border="0">
				<TR>
					<TD colspan="2">&nbsp;</TD>
