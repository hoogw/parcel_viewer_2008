<%@ Page Language="vb" AutoEventWireup="false" Codebehind="BM_Create.aspx.vb" Inherits="dotNETViewer.BM_Create"%>
...
'
'************************************************************************************************************************************
Response.Write(context.application("TimeOutPublic") & "<BR>")
Response.Write(context.application("TimeOutPrivate"))
Response.Write(context.session("bookmark").expiration)

dim i as string
For each i in session.contents
	Response.Write (i & "<BR>")
Next
Response.Write(Session("gdbsource"))
%>
	...
	<BODY onload="try {document.BMForm.UserName.focus();} catch(e){};">
		...
		<FORM id="BMForm" name="BMForm" runat="server">
			...
			<TABLE width="100%" cellpadding="3" cellspacing="0" border="0">
				...
				<TR>
					<TD>&nbsp;</TD>
					<TD align=left><asp:RadioButton ID="Radiobutton3" onclick="document.BMForm.BMName.value='Default';" GroupName="BMPubPriv" Text="Default" Runat="server"></asp:RadioButton></TD>
				</TR>
				<TR>
					<TD colspan="2"><hr>
					</TD>
