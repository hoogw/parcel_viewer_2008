	...
	<BODY>
		...
		<FORM id="BMForm" name="BMForm" runat="server">
			...
			<TABLE width=100% cellpadding="3" cellspacing="0" border="0">
				<TR>
					<TD colspan="2" align="center"><FONT class="sshdr1">Create a Bookmark</FONT><br><hr></TD>
				</TR>
				<TR valign="top">
				...
				<TR>
					<TD>&nbsp;</TD>
					<TD><asp:RadioButton ID="BMPub" GroupName="BMPubPriv" Text="Public" Runat="server"></asp:RadioButton><br>
