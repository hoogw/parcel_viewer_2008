...
// was published on http://www.siteexperts.com/tips/techniques/ts03/index.aspx
//---------------------------------------------------------------------------
...
if (isIndex && (toc.location.href.substring(toc.location.href.lastIndexOf("/")+1,toc.location.href.length) != "geoprisepc_kwindex.aspx")) { isIndex=false; isContent=true; }
...
toc.document.write("<span style='cursor:default'><img src=\"" + img + "\" border=0></span></a>");
...
toc.document.write("\n\r\n\r<hr><FONT face=\"Arial,Helvetica\" size=\"1\">&copy; 2002-" + d.getFullYear() + " GeoPrise.NET</FONT>\n\r</BODY>\n\r</HTML>\n\r");
toc.document.close();
