<%@ Page Language="vb" AutoEventWireup="false" Codebehind="admin_l_division.aspx.vb" Inherits="dotNETViewer.Admin_l_division" %>
<%
'************************************************************************************************************************************
'	ASPX PAGE
'
...
'	
'	The purpose of this page is to provide the HTML interface to administer the project divisions (add, edit, delete, and view).
		...
		<CENTER>
			<FORM id="adminForm" name="adminForm" runat="server">
				...
				<TABLE cellpadding="2" cellspacing="1">
					...
					<TR valign="top">
						<TD width="45%"><asp:Label ID="DivisionLabel" visible="False" Runat="server">Select a Division:</asp:Label></TD>
						<TD width="55%"><asp:DropDownList cssclass="HTMLFrmObjects" ID="DivisionSelection" Visible="False" AutoPostBack="True"
								Runat="server" Width="200"></asp:DropDownList></TD>
					</TR>
					<TR valign="top">
						<TD>Division Name:&nbsp;</TD>
						<TD><asp:TextBox cssclass="HTMLFrmObjects" ID="DivisionName" Runat="server" MaxLength="50" Width="200"></asp:TextBox></TD>
					</TR>
					<TR valign="top">
						<TD>Division Description:&nbsp;</TD>
						<TD><asp:TextBox cssclass="HTMLFrmObjects" ID="DivisionDesc" Runat="server" Rows="5" TextMode="MultiLine"
								Width="200"></asp:TextBox></TD>
					</TR>
					<TR valign="top">
						<TD>Owner:&nbsp;</TD>
						<TD><asp:DropDownList cssclass="HTMLFrmObjects" ID="Owner" AutoPostBack="False" Runat="server" Width="200"></asp:DropDownList></TD>
					</TR>
					<%if ACN = "Edit" then %>
					<TR valign="top">
					...
					<asp:RequiredFieldValidator id="valDivisionSelection" ControlToValidate="DivisionSelection" ErrorMessage=" - You must select a Division from the drop down box."
						EnableClientScript="true" Display="None" Runat="server" />
					<%end if
				if ACN = "Add" or ACN = "Edit" then%>
					<asp:RequiredFieldValidator id="valDivisionName" ControlToValidate="DivisionName" ErrorMessage=" - Division Name is a required field."
						EnableClientScript="true" Display="None" Runat="server" />
					<asp:RequiredFieldValidator id="valDivisionDesc" ControlToValidate="DivisionDesc" ErrorMessage=" - Division Description is a required field."
						EnableClientScript="true" Display="None" Runat="server" />
					<asp:RequiredFieldValidator id="valOwner" ControlToValidate="Owner" ErrorMessage=" - You must select at least one Owner for this Division."
						EnableClientScript="true" Display="None" Runat="server" />
					<%end if%>
				</TABLE>
				<%else%>
