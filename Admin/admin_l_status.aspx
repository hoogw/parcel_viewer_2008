<%@ Page Language="vb" AutoEventWireup="false" Codebehind="admin_l_status.aspx.vb" Inherits="dotNETViewer.Admin_l_status" %>
<%
'************************************************************************************************************************************
'	ASPX PAGE
'
...
'	
'	The purpose of this page is to provide the HTML interface to administer the project Status (add, edit, delete, and view).
		...
		<CENTER>
			<FORM id="adminForm" name="adminForm" runat="server">
				...
				<TABLE cellpadding="2" cellspacing="1">
					...
					<TR valign="top">
						<TD width="45%"><asp:Label ID="StatusLabel" visible="False" Runat="server">Select a Project Status:</asp:Label></TD>
						<TD width="55%"><asp:DropDownList cssclass="HTMLFrmObjects" ID="StatusSelection" Visible="False" AutoPostBack="True"
								Runat="server" Width="200"></asp:DropDownList></TD>
					</TR>
					<TR valign="top">
						<TD>Project Status Name:&nbsp;</TD>
						<TD><asp:TextBox cssclass="HTMLFrmObjects" ID="StatusName" Runat="server" MaxLength="50" Width="200"></asp:TextBox></TD>
					</TR>
					<TR valign="top">
						<TD>Priority Level:&nbsp;</TD>
						<TD><asp:TextBox cssclass="HTMLFrmObjects" ID="Priority" Runat="server" MaxLength="3" Width="200"></asp:TextBox></TD>
					</TR>
					<%if ACN = "Edit" then %>
					<TR valign="top">
					...
					<asp:RequiredFieldValidator id="valStatusSelection" ControlToValidate="StatusSelection" ErrorMessage=" - You must select a Project Status from the drop down box."
						EnableClientScript="true" Display="None" Runat="server" />
					<%end if
				if ACN = "Add" or ACN = "Edit" then%>
					<asp:RequiredFieldValidator id="valStatusName" ControlToValidate="StatusName" ErrorMessage=" - Status Name is a required field."
						EnableClientScript="true" Display="None" Runat="server" />
					<asp:RequiredFieldValidator id="valPriority" ControlToValidate="Priority" ErrorMessage=" - Priority is a required field."
						EnableClientScript="true" Display="None" Runat="server" />
					<%end if%>
				</TABLE>
				<%else%>
