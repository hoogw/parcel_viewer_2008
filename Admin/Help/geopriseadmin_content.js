...
tocTab[ir++] = new Array ("2", "Administrator Utilities", "", "", "cicon1.gif", "cicon2.gif");
tocTab[ir++] = new Array ("2.1", "Add Record", "addproject.htm", "", "cicon11.gif", "cicon11.gif");
tocTab[ir++] = new Array ("2.2", "Edit Record", "editproject.htm", "", "cicon11.gif", "cicon11.gif");
tocTab[ir++] = new Array ("2.3", "Delete Record", "deleteproject.htm", "", "cicon11.gif", "cicon11.gif");
tocTab[ir++] = new Array ("2.4", "Account Administration", "accountadministration.htm", "", "cicon1.gif", "cicon2.gif");
tocTab[ir++] = new Array ("2.4.1", "Project Contacts", "projectcontacts.htm", "", "cicon11.gif", "cicon11.gif");
tocTab[ir++] = new Array ("2.4.2", "Coordinate Projects", "coordinateprojects.htm", "", "cicon11.gif", "cicon11.gif");
tocTab[ir++] = new Array ("2.4.3", "Account Manager", "accountmanager.htm", "", "cicon11.gif", "cicon11.gif");
tocTab[ir++] = new Array ("2.4.4", "Application Tables", "applicationtables.htm", "", "cicon11.gif", "cicon11.gif");
tocTab[ir++] = new Array ("2.4.5", "Project Results", "projectresults.htm", "", "cicon11.gif", "cicon11.gif");
tocTab[ir++] = new Array ("2.4.6", "Administration Help", "administrationhelp.htm", "", "cicon11.gif", "cicon11.gif");
isContent = true,
isIndex = false,
showNumbers = false,
...
if (isIndex && (toc.location.href.substring(toc.location.href.lastIndexOf("/")+1,toc.location.href.length) != "geopriseadmin_kwindex.htm")) { isIndex=false; isContent=true; }
...
toc.location.href = "geopriseadmin_kwindex.htm";
isIndex = true;
}
if (isContent) {
...
if (isContent) {
toc.document.write("\n\r\n\r<hr><font face=\"Arial,Helvetica\" size=\"1\">&copy; 2003 ... Your company</font>\n\r</body>\n\r</html>\n\r");
toc.document.close();
