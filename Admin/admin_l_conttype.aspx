<%@ Page Language="vb" AutoEventWireup="false" Codebehind="admin_l_conttype.aspx.vb" Inherits="dotNETViewer.Admin_l_conttype" %>
<%
'************************************************************************************************************************************
'	ASPX PAGE
'
...
'	
'	The purpose of this page is to provide the HTML interface to administer the project contact types (add, edit, delete, and view).
		...
		<FORM id="adminForm" name="adminForm" runat="server">
			<CENTER>
				...
				<TABLE cellpadding="2" cellspacing="1">
					...
					<TR valign="top">
						<TD width="45%"><asp:Label ID="ContactTypeLabel" visible="False" Runat="server">Select a Contact Type:</asp:Label></TD>
						<TD width="55%"><asp:DropDownList cssclass=HTMLFrmObjects  ID="ContactTypeSelection" Visible="False" AutoPostBack="True" Runat="server" Width="200"></asp:DropDownList></TD>
					</TR>
					<TR valign="top">
						<TD>Contact Type Name:&nbsp;</TD>
						<TD><asp:TextBox cssclass=HTMLFrmObjects ID="ContactTypeName" Runat="server" MaxLength="50" Width="200"></asp:TextBox></TD>
					</TR>
					<TR valign="top">
						<TD>Default Contact Type?:&nbsp;</TD>
						<TD><asp:CheckBox ID="DefaultType" Runat="server"></asp:CheckBox></TD>
					</TR>
					<%if ACN = "Edit" then %>
					<TR valign="top">
					...
					<asp:RequiredFieldValidator id="valContactTypeSelection" ControlToValidate="ContactTypeSelection" ErrorMessage=" - You must select a Contact Type Name from the drop down box." EnableClientScript="true" Display="None" Runat="server" />
					<%end if
				if ACN = "Add" or ACN = "Edit" then%>
					<asp:RequiredFieldValidator id="valContactTypeName" ControlToValidate="ContactTypeName" ErrorMessage=" - Contact Type Name is a required field." EnableClientScript="true" Display="None" Runat="server" />
					<%end if%>
				</TABLE>
				<%else%>
				<CENTER>
