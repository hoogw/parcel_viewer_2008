...
x= ""
Response.Write ("<BR><BR><BR><BR>----------------- FORM ----------------<BR><BR>")
for each x in Request.form
	Response.Write (x & " - " & Request.form(x) & vbcrlf)   
Next

Response.Write(Application("DispMLRes") & "<BR><BR>")
Response.Write(Application("DispMLOwn") & "<BR><BR>")
Response.Write(Application("methMailingLabels") & "<BR><BR>")
Response.Write(Request("l") & "<BR><BR>")
Response.Write(Application("DoesMailingLabels") & "<BR><BR>")


Application("methMailingLabels") =1
'Response.end
