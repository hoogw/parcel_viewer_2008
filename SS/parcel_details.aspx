<%@ Page Language="vb" AutoEventWireup="false" Codebehind="parcel_details.aspx.vb" Inherits="dotNETViewer.parcel_details"%>
<%
'************************************************************************************************************************************
'	ASPX PAGE
'
...
'
'	The purpose of this page is to provide the HTML interface to display parcel details.  All of the HTML code is generated in the
...
<HTML>
	<HEAD>
		<TITLE>parcel_details</TITLE>
		<!--#include file="../includes/header.aspx"-->
	</HEAD>
	<BODY onload="top.HaltLYRHide=0; top.MapFrame.hideLoadingLyr()">
		<!--- GeopriseVariables.txt file variable PDData --->
