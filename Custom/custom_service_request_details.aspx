...
<%
	if request("GVar")="" and idalliFrame=true then
		...
		strSQL = "Select * from " & Trim(session("DBTbl")) & " where RequestID in ("
		strSQL &= "'" & request("pid") & "')"
	...
	response.write ("<font class=SSHdr2>Service Request Details for Request ID: " & request("pid") & "<br><br></font>")
...
response.write ("<td>" & thisvalue & "</TD>")
			...
			Coords &= n & "," & DT.Rows(i)(DT.columns.count-2) & "," & DT.Rows(i)(DT.columns.count-1) & ","
