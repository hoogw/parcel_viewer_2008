...
} catch(e) {prefix=top.MapFrame; prefixTop=top;};
...
<%
	if request("GVar")="" and idalliFrame=true then
		...
		strSQL = "Select * from " & Trim(session("DBTbl")) & " where Permit_Number in ("
		strSQL &= "'" & request("pid") & "')"
	...
	response.write ("<tr><Td class=tblHdr>PermitSoft</Td><td><a href=""javascript:PermitSoft('" & DT.ROws(i)(0) & "');"">Click Here</a></td></tr>")
	response.write ("<tr><Td class=tblHdr>Imaging</Td><td><a href=""javascript:SIRE('CD_BLDG_App_Plans|Application_Number|" & DT.Rows(i)(1) & "|CD_BLDG_App_Reports|Application_Number|" & DT.Rows(i)(1) & "|CD_BLDG_Permits_and_Apps|Application_Number|" & DT.Rows(i)(1) & "',3);"">Click Here</a></td></tr>")
