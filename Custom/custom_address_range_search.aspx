...
<SCRIPT LANGUAGE='JavaScript' TYPE='text/javascript'>
	function submitit() {
			if (trim(document.frmDB.SAfld0.value)=='' && trim(document.frmDB.SAfld1.value)=='' && trim(document.frmDB.SAfld2.value)=='') {
	...
	<BODY class="colr" LEFTMARGIN="2" TOPMARGIN="0" RIGHTMARGIN="0" onload="top.MapFrame.hideLoadingLyr()">
			...
			<td align=center><b>Address Range Search</b></font></td></tr></table>
			<br>
			<table>
				<tr>
					<td></td>
				...
				<tr>
					<td></td>
					<td><input tabindex=1 type="text" name="SAfld0" size="14" value="" ID="Text1"></td>
				</tr>
				<tr>
					<td></td>
					<td>End Number:</td>
				...
				<tr>
					<td></td>
					<td><input tabindex=2 type="text" name="SAfld1" size="22" value="" ID="Text2"></td>
				</tr>
				<tr>
					<td></td>
					<td><br></td>
				...
				<tr>
					<td></td>
					<td><input tabindex=3 type="text" name="SAfld2" size="22" value="" ID="Text1"></td>
				</tr>
				 <tr>
					<td></td>
					<td><br></td>
				...
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td><a href='javascript:searchTips()'>Address Range Search Tips</a></font></td>
				</tr>
				...
				<tr>
					<td colspan="2" align="center"><br>
						<input tabindex=4 type=submit class=Btn  Value="Submit">
					</td>
				</tr>
 				<tr>
					<td></td>
				...
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td style='color:red'>To search using standard Address Criteria, <a 					href="custom_address_search.aspx">click 					here</a></td>
				</tr>
 				<tr>
					<td></td>
					<td><br></td>
