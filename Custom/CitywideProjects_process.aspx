...
'	if CInt(Request.Form("FieldCount"))=0 then
'		response.write ("No Citywide Projects found!")
'		response.end
'	end if
...
response.write ("<TD class=tblHdr><nobr>ST Number</nobr></td>")
response.write ("<TD class=tblHdr><nobr>Unit Desig</nobr></td>")
...
response.write ("<TD class=tblHdr><nobr>City Project #</nobr></td>")
response.write ("<TD class=tblHdr><nobr>Project Name</nobr></td>")
response.write ("<TD class=tblHdr><nobr>Description</nobr></td>")
response.write ("<TD class=tblHdr><nobr>App. Date</nobr></td>")
response.write ("<TD class=tblHdr><nobr>Poly Description</nobr></td>")
...
'			response.write ("<TD><center><a href='javascript:SendValue(""" & Trim(CStr(session("Fld_SHP"))) & """,""" & IDValue & """,""" & CustLayer & """);'>Rec " & n & "</a></center></TD>")
			...
			response.write ("<TD width=85><nobr><center><a href=""javascript:SIRE('" & DT.Rows(i)(5) & "',1);"">" & DT.Rows(i)(5) & "</a></center></nobr></TD>")
