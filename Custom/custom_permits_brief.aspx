...
function SIRE(v) {
	window.open('int_SIRE.aspx?id=Application_Number,' + v);
}
...
'			response.write ("<TD width=85><nobr><center><a href='javascript:SendValue(""" & Trim(CStr(session("Fld_SHP"))) & """,""" & IDValue & """,""" & CustLayer & """);'>Rec " & n & "</a></center></nobr></TD>")
			'response.write ("<td class=tblHdr><nobr>PermitCity</nobr></td><td><a href=""javascript:PermitSoft('" & IDValue & "');"">Click Here</a></TD>")
'			response.write ("<TD width=85><nobr><center><a href='javascript:SIRE(1);'>Rec " & n & "</a></center></nobr></TD>")
			response.write ("<TD width=85 class=tblHdr><nobr>Permit Details</nobr></td><td><a href=""javascript:PermitDetails('" & IDValue & "');"">" & IDValue & "</a></nobr></TD>")
