...
'	response.write(session("ds"))
	...
	dim sit1,sit2,sit3,mail1,mail2,mail3,apn, name,j
	Dim Information
	...
	if AddressLabelType = 0 or AddressLabelType=2 then
		for i = 0 to DT.Rows.Count
			...
			Information &= "<FONT color=black size='-2'><br>" & sit2 & " " & sit3 & "</font>"
			recCount = recCount + 1
    ...
    'APN,situs1,sa_city_an,sa_zip_cde,c_owners,mailing_a,c_mcityst,c_mail_zi
    Information &= ("<TABLE border='0' width='100%'><TR valign=top>")
    columncount = 4
    'Owner
