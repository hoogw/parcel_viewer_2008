...
session("Fld_DBNAMES")="APPLICATION_NUMBER,PERMIT_NUMBER,PROJECT,APN,PERMIT_STATUS,TOTAL_FEE,VALUATION,APPLICATION_DATE,ISSUED_DATE,FINALED_DATE,WORK_TYPE,WORK_DESCRIPTION,RES_COMM,ADDRESS_ID,PREFIX_TYPE,PREFIX_DIR,ST_NUMBER,ST_NAME,ST_TYPE,SUFFIX_DIR,CITY,ZIP,FULL_ADDRESS,ADDR_FRACTION,UNIT_DESIGNATOR,UNIT,FLOOR,BUILDING,"
...
<%
	if request("GVar")="" and idalliFrame=true then
		...
		strSQL = "Select " & session("Fld_DBNAMES") & session("Fld_DB") & " from " & Trim(session("DBTbl")) & " where Permit_Number in ("
		strSQL &= "'" & request("pid") & "')"
...
select case j
case 0:
response.write ("<TD class=tblHdr width=150><nobr>Application Number</nobr></td>")
case 1:
response.write ("<TD class=tblHdr><nobr>Permit Number</nobr></td>")
case 2:
response.write ("<TD class=tblHdr><nobr>Project</nobr></td>")
case 3:
response.write ("<TD class=tblHdr><nobr>APN</nobr></td>")
case 4:
response.write ("<TD class=tblHdr><nobr>Permit Status</nobr></td>")
case 5:
response.write ("<TD class=tblHdr><nobr>Total Fee</nobr></td>")
case 6:
response.write ("<TD class=tblHdr><nobr>Valuation</nobr></td>")
case 7:
response.write ("<TD class=tblHdr><nobr>Application Date</nobr></td>")
case 8:
...
case 12:
response.write ("<TD class=tblHdr><nobr>Res Comm</nobr></td>")
case 13:
response.write ("<TD class=tblHdr><nobr>Address ID</nobr></td>")
case 14:
response.write ("<TD class=tblHdr><nobr>Previx Type</nobr></td>")
case 15:
response.write ("<TD class=tblHdr><nobr>Prefix Dir</nobr></td>")
case 16:
response.write ("<TD class=tblHdr><nobr>Street Number</nobr></td>")
case 17:
response.write ("<TD class=tblHdr><nobr>Street Name</nobr></td>")
case 18:
response.write ("<TD class=tblHdr><nobr>Street Type</nobr></td>")
case 19:
response.write ("<TD class=tblHdr><nobr>Suffix Dir</nobr></td>")
case 20:
response.write ("<TD class=tblHdr><nobr>City</nobr></td>")
case 21:
response.write ("<TD class=tblHdr><nobr>ZIP Code</nobr></td>")
case 22:
response.write ("<TD class=tblHdr><nobr>Full Address</nobr></td>")
case 23:
response.write ("<TD class=tblHdr><nobr>Addr Fraction</nobr></td>")
case 24:
response.write ("<TD class=tblHdr><nobr>Unit Designation</nobr></td>")
case 25:
response.write ("<TD class=tblHdr><nobr>Unit</nobr></td>")
case 26:
response.write ("<TD class=tblHdr><nobr>Floor</nobr></td>")
case 27:
response.write ("<TD class=tblHdr><nobr>Building</nobr></td>")
end select
