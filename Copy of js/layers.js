//	K-Layer functions  see http://www.kruglov.ru/klayers/ for more information
function initKLayers(){
  ...
  isMozilla=isNN6=isNC6=isNN && isDOM
...
KLP.setWidth=function(w){/////
  if(isMSIE || isMozilla || isOpera7)this.css.width=w;
  if(isOpera)this.css.pixelWidth=w;
}
KLP.setHeight=function(h){/////
  if(isMSIE || isMozilla || isOpera7)this.css.height=h;
  if(isOpera)this.css.pixelHeight=h;
}
...
KLP.size=function(w,h){
	this.setWidth(w);
	this.setHeight(h);
}
//KLP.size=function(right,bottom){
//  if(isMSIE){
//	this.css.width=(right);this.css.height=(bottom);
//  }
//}
