...
<tr>
<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
<td><span style='color:red;font-family:arial;font-size:10px;font-weight:normal;'>* Please note that your "Pop-Up" blocker must be disabled in order to use this feature</span>
</td>
<td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
</tr>
</table>
            <hr>
            <center>
            <input id="Submit1" ONCLICK="return PrintView();"  type="submit" class=btn value="Print Preview" NAME="printPreview">
            </center>
            <br>
            <center>
            <input id="Generate_PDF" ONCLICK="return GeneratePDF();" type="button" class=btn value="Generate PDF" NAME="Generate_PDF">
            </center>
		</FORM>
